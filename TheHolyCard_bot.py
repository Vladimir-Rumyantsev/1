...
def telegram_bot(token):
    ...
    def send_text(message):
        def card(a):
            ...
            # print(f'Была команда /{a} от:', person)
        ...
        try:
            ...
            if message.text.lower() == '/start':
                bot.send_message(
                    ...
                    f"\nВот его номер, отправить можно на Сбер или Тинькофф:"
                    f"\n89223046762"
                )
                bot.send_message(
                    person,
                ...
                # print('Была команда /start от:', person)
                ...
                # print('Была команда /card от:', person)
                ...
                # print('Была команда /exam от:', person)
                ...
                bot.send_message(
                    person,
                    'Извините, тут даже звёзды в замешательстве. Спросите у ChatGPT'
                )
                # print('Была неготовая команда от:', person)
